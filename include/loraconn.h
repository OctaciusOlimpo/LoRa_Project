...
//End of Pinout Settings.

#define BAND    915E6 //Radio frequency - example: 433E6, 868E6, 915E6 Hz.

class LoRaConn
{
    private:
        //Arrays to store available values.
        ...
        const bool paBoostOptions[2] = {false, true};
